...
public class nonStrategic {
     public static ArrayList<Double> reallocSemiStrategic(int numOnline, int numPhysical, int cost, int arrivalRate, double alpha, double physicalPopulation, double onlinePopulation, int numCustomer){
        ...
        for(int i = 0; i < numCustomer; i++){
            ...
            totalTimeArray.add(costMap.get((double)i));
        }
    ...
    public static ArrayList<Double> noReallocNonStrategic(int numOnline, int numPhysical, int cost, int arrivalRate, double alpha, double physicalPopulation, double onlinePopulation, int numCustomer){
        int numCustomerArrived = 0;
        ArrayList<Double> totalTimeArray = new ArrayList<Double>();
        ArrayList<Integer> currentStrategy = new ArrayList<Integer>();
        Map<Double, Double> costMap = new HashMap<Double, Double>();
